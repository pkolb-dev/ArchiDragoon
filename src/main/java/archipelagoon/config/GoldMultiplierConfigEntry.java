...
public class GoldMultiplierConfigEntry extends ConfigEntry<Float> {
  public GoldMultiplierConfigEntry() {
    super(2.0f, ConfigStorageLocation.CAMPAIGN, ConfigCategory.GAMEPLAY, GoldMultiplierConfigEntry::serializer, GoldMultiplierConfigEntry::deserializer);

    this.setEditControl((number, gameState) -> {
      final NumberSpinner<Float> spinner = NumberSpinner.percentSpinner(number, 0.05f, 0.25f, 1.0f, 2.0f);
